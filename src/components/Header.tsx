    ...
    <div className="relative w-full">
      ...
      <div className="absolute left-16 right-16 top-8 flex items-center justify-between">
        ...
        {onStartOver && (
          <button
            onClick={onStartOver}
            className="px-3 py-1 text-sm bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white rounded-lg transition-all duration-200 flex items-center gap-2"
